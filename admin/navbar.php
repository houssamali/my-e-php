        ...
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item dropdown">
            ...
            <ul class="dropdown-menu bg-dark" aria-labelledby="navbarDropdown">
              <li ><a class="dropdown-item text-success bg-dark" href="http://localhost/houssam/frontend/category.php">View Website</a></li>
         ...
         <li class="nav-item">
            <a class="nav-link" href="comment.php?do=manage">Comments</a>
          </li>
...
<form  action="item.php" method="post" class="d-flex" role="search">
